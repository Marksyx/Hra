...
string boj(int monstrum)
{
    int tah = 1;
    cout << hrdinove[muj_hrdina].jmeno << endl;
    cout << monstra[monstrum].jmeno << endl;
    system("pause");
    do
    {
        cout << "Hrdina: " << hrdinove[muj_hrdina].zivoty << endl;
        cout << "Monstrum: " << monstra[monstrum].zivoty << endl;

        cout << "Tah " << tah++ << ".: " << endl;

        monstra[monstrum].zivoty = monstra[monstrum].zivoty - hrdinove[muj_hrdina].utok;
        if(monstra[monstrum].zivoty < 0)
        {
            cout << "Hrdina vyhrál souboj" << endl;
            konec(true);
        }

        hrdinove[muj_hrdina].zivoty = hrdinove[muj_hrdina].zivoty - monstra[monstrum].utok;
